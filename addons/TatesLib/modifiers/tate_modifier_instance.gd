...
var modifier_data: TateModifier
var target: Node
var time_left: float
var stack: int = 1

## Increases stack and tells the TateModifier associated with modifier_data 
## to reapply().
...
## Decreases stack and tells the TateModifier associated with modifier_data 
## to reapply().
