...
signal pressed(option: TatePurchaseOption)
...
func setup(option_data: TatePurchaseOption, override_cost: float = NAN) -> void:
	data = option_data
	
	var warning_prefix : String = "TateChoiceSlot has no "
